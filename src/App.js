          ...
          <div className="main">
              ...
              <div className="highlights">
                  ...
                  <div className="highlights__body">
                      <div className="highlights__item uv-index">5</div>
                      <div className="highlights__item wind-status">7.7</div>
                      <div className="highlights__item sunrise-and-sunset">
                          <div className=" sunrise">6:35 AM</div>
                          <div className="sunset">5:42 PM</div>
                      </div>
                      <div className="highlights__item humidity">12%</div>
                      <div className="highlights__item visibility">5.2km</div>
                      <div className="highlights__item ait-quality">105</div>
                  </div>
              </div>
          </div>
      </div>
